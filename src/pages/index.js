  ...
  <div>
    ...
    <div>
      ...
      <div>
        ...
        <p><a href="https://pypi.python.org/pypi/plone.restapi"></a></p>
      ...
      <div>
        ...
        <p>Ships with Plone 5.2.</p>
        <p><a href="https://pypi.python.org/pypi/plone.rest">Pypi Link</a></p>
      </div>
      <div>
        <h4>plone.app.contenttypes</h4>
        <p>Default content types for Plone based on Dexterity.</p>
        <p>Ships with Plone since 4.3</p>
        <p><a href="https://pypi.python.org/pypi/plone.app.contenttypes">Pypi Link</a></p>
    ...
    <div>
      ...
      <div>
        ...
        <p>A PAS plugin that authenticates users against a CAS (Central Authentication Service) server.</p>
      <div>
